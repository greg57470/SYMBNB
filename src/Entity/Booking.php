...
class Booking
{
     ...
     * @Assert\GreaterThan("today", message="La date d'arrivée doit être ultérieure a la date d'aujourd'hui !", groups={"front"})
     */
    private $startDate;
    ...
    /**
     * Callback appelé a chque fois qu'on créer une réservation
     * 
     * @ORM\PrePersist
     * @ORM\PreUpdate
     *
    ...
    public function isBookableDates(){
        ...
        // 2) I faut ocmparer les dates choisies avec les dates impossibles
